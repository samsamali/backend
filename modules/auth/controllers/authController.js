...
//   try {
//     const { name, email, password, subscriptionid, roleid, groupid } = req.body;
...
//         });
//       } else {
//         // Customer without subscription → trial group
...
//           permissions: groupPermissions,
//         };
//         // No UserSubscription for trial customers
//       }

//       // Build customer modules using group permissions (existing logic)
...
//     // =============================================
//     // NON-CUSTOMER ROLE — role-based only, no group, no subscription
//     // =============================================
//     } else {
//       const rolePermissions = await RolePermission.find({
//         roleId: role._id,
...
//       // groupInfo stays null, userSubscription stays null, groupPermissions stays []
//     }
...
//     // Only add group/permissions to token for customer roles
//     if (isCustomer) {
...
//     // Only include customer-specific fields for customer role
//     if (isCustomer) {
...
// // ── Helper: build base module object from a module doc ──
...
//     // 5. Get RolePermissions for this role → gives us modulePermissionIds
//     const rolePermissions = await RolePermission.find({
...
//       path: "modulePermissionId",
//       populate: [
//         { path: "moduleId" },   // full Module object
//         { path: "permissionId" } // full Permission object
//       ],
//     });

//     // 6. Build modules map: moduleId → { module info, permissions[] }
//     const modulesMap = {};

//     for (const rp of rolePermissions) {
//       const mp = rp.modulePermissionId;

//       // Skip if modulePermission, module, or permission is inactive/missing
//       if (!mp || !mp.is_active) continue;
//       if (!mp.moduleId || !mp.moduleId.is_active) continue;
//       if (!mp.permissionId) continue;
...
//       // Add permission code if not already added
//       if (!modulesMap[moduleId].permissions.includes(mp.permissionId.code)) {
//         modulesMap[moduleId].permissions.push(mp.permissionId.code);
//       }
//     }

//     // 7. Convert map to array (only modules that have at least 1 permission)
...
// ================================================================
//  authController.js — UPDATED with Company Store Access Control
//  Changes: signup + login now include companyId + allowedStoreIds
//  in JWT and response. Everything else is IDENTICAL to original.
// ================================================================

// ── ADD THESE to your existing requires at the top ───────────────
// const CompanyStore = require('../../admin/models/CompanyStore');
// const UserCompany  = require('../../admin/models/UserCompany');
// (Add alongside your existing User, Role, etc. requires)
